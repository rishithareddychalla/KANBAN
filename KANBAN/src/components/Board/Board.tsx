...
export const Board = () => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto px-4 py-8 animate-fade-in">
      ...
      >
        <div className="flex flex-col gap-3.5 p-4 rounded-2xl bg-slate-900/30 border border-white/5 shadow-glass backdrop-blur-md">
          {/* Top Row: Search & Priority */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full">
            ...
            {/* Priority Filter */}
            <div className="flex items-center gap-2 self-start md:self-auto w-full md:w-auto overflow-x-auto no-scrollbar">
              <div className="flex items-center gap-1.5 text-xs text-slate-400 font-semibold mr-1 shrink-0">
              ...
              <div className="flex items-center gap-1">
                {(['all', 'low', 'medium', 'high'] as const).map((p) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold capitalize transition-all duration-200 shrink-0 select-none border
                      ${priorityFilter === p
          ...
          {allUniqueTags.length > 0 && (
            <div className="flex flex-col gap-2 pt-3.5 border-t border-white/5 w-full">
